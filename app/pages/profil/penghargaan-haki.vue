  ...
  <section class="bg-gradient-to- from-emerald-50 via-white to-emerald-50 pt-20">
    ...
    <div class="max-w-7xl mx-auto px-6 py-5">
      <div class="relative bg-emerald-600 rounded-3xl p-10 text-white overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
          <h1 class="text-4xl font-bold">Penghargaan dan HAKI RSUD Dr. Soetomo</h1>
    ...
    <div class="max-w-7xl mx-auto px-6 py-14">
      <transition name="fade" mode="out-in">
        <Penghargaan
          v-if="activeTab === 'penghargaan'"
          key="penghargaan"
          class="bg-white rounded-3xl shadow-lg p-10 -mt-10"
        />

        <Haki v-else key="haki" class="bg-white rounded-3xl shadow-lg p-10 -mt-10" />
      </transition>
    </div>
  </section>
</template>
...
import Penghargaan from "~/components/profil/penghargaanhaki/Penghargaan.vue";
import Haki from "~/components/profil/penghargaanhaki/Haki.vue";
...
const activeTab = ref<TabItem["key"]>("penghargaan");
