    ...
    <div class="max-w-7xl mx-auto px-6 py-5">
      <div class="relative bg-emerald-600 rounded-3xl p-10 text-white overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
          <h1 class="text-4xl font-bold">Struktur Organisasi RSUD Dr. Soetomo</h1>
...
import StrukturOrganisasiSK from "~/components/profil/strukturorganisasi/StrukturOrganisasiSK.vue";
import ProfilDireksi from "~/components/profil/strukturorganisasi/ProfilDireksi.vue";
import DaftarUnitKerja from "~/components/profil/strukturorganisasi/DaftarUnitKerja.vue";
...
/* =====================
  ...
  ===================== */
interface TabItem {
  key: "struktur-organisasi" | "profil-direksi" | "daftar-unit-kerja";
  label: string;
}

const tabs: TabItem[] = [
  { key: "struktur-organisasi", label: "Struktur Organisasi" },
  { key: "profil-direksi", label: "Profil Direksi" },
  { key: "daftar-unit-kerja", label: "Daftar Unit Kerja" },
];
...
const tabComponent = computed(() => {
  const map: Record<TabItem["key"], any> = {
    "struktur-organisasi": StrukturOrganisasiSK,
    "profil-direksi": ProfilDireksi,
    "daftar-unit-kerja": DaftarUnitKerja,
  };
...
/* =====================
  ...
  ===================== */
definePageMeta({
  breadcrumb: [{ label: "Beranda", to: "/" }, { label: "Profil - Struktur Organisasi" }],
});
