    ...
    <div class="max-w-7xl mx-auto px-6 py-5">
      <div class="relative bg-emerald-600 rounded-3xl p-10 text-white overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
          <h1 class="text-4xl font-bold">Visi dan Misi RSUD Dr. Soetomo</h1>
...
import VisiMisi from "~/components/profil/visimisi/VisiMisi.vue";
import NilaiMotto from "~/components/profil/visimisi/NilaiMotto.vue";
...
/* =====================
  ...
  ===================== */
interface TabItem {
  key: "visi-misi" | "nilai-motto";
  label: string;
}

const tabs: TabItem[] = [
  { key: "visi-misi", label: "Visi & Misi" },
  { key: "nilai-motto", label: "Nilai & Motto" },
];
