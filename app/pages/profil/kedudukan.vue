    ...
    <div class="max-w-7xl mx-auto px-6 py-5">
      <div class="relative bg-emerald-600 rounded-3xl p-10 text-white overflow-hidden">
        ...
        <div class="relative z-10 max-w-3xl">
          <h1 class="text-4xl font-bold">Kedudukan RSUD Dr. Soetomo</h1>
...
import Kedudukan from "~/components/profil/kedudukan/Kedudukan.vue";
import KontakPenting from "~/components/profil/kedudukan/KontakPenting.vue";
import Denah from "~/components/profil/kedudukan/Denah.vue";
